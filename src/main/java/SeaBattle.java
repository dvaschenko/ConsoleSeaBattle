import Utils.ConsoleHandling.InReader;
import Utils.ConsoleHandling.Printer;
import Utils.ShipPlacers.ComputerShipPlacer;
import Utils.ShipPlacers.PlayerShipPlacer;
...
public class SeaBattle {
    ...
    //todo fix second hit error
    //todo rework field printing (always print?)
    //todo fill spots around destroyed ship
    //todo make AI smarter
    //todo make AI unwinnable
    //todo add tests
    public void play() {
    ...
    public void start() {
        ...
        printer.printYouField();
        printer.printOpenField(playerField);
        printer.printOpponentField();
