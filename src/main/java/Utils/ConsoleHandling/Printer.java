package Utils.ConsoleHandling;

import components.ConsoleColors;
...
public class Printer {
    ...
    public void printYouField(){
        String YOU_FIELD = "Here is yours Playing field :";
        System.out.println(YOU_FIELD);
    }

    public void printOpponentField(){
        String OPPONENT_FIELD = "Here is your enemy Playing field :";
        System.out.println(OPPONENT_FIELD);
    }
    ...
    public void compMoves() {
        String COMP_MOVES = "Now is a computer turn: ";
        System.out.println(COMP_MOVES);
    }

    public void playerMoves() {
        String PLAYER_MOVES = "Now is your turn: ";
    ...
    public void printOpenField(Field field) {
        ...
        for (int[] row : toPrint
            ...
            for (int i : row
                ...
                String coloredPrint = colorOutput(i);
                System.out.print(" " + coloredPrint + " ");
            }
            System.out.println();
            ++rowNumber;
        }
    ...
    private String colorOutput(int i) {
        String colored = "";

        switch (i) {
            case 126 : {
                colored = colored + ConsoleColors.BLUE + (char) i + ConsoleColors.RESET;
                break;
            }
            case 35 : {
                colored = colored + ConsoleColors.GREEN + (char) i + ConsoleColors.RESET;
                break;
            }

            case 42 : {
                colored = colored + ConsoleColors.YELLOW + (char) i + ConsoleColors.RESET;
                break;
            }

            case 88 : {
                colored = colored + ConsoleColors.RED + (char) i + ConsoleColors.RESET;
                break;
            }
